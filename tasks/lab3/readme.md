...
Создайте файл `urls.py` в данном приложении (`db_train_alternative`) и опишите в `urls.py` пути. Опять же архитектурный стиль REST, одно отображение, но благодаря
